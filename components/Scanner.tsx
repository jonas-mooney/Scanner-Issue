...
const Scanner = () => {
  ...
  const handleProductInfoDismiss = () => {
    // Prior to adding this worklet tag, even the console.log would cause Expo Go to crash.
    'worklet';
    console.log('Product Info popup dismissed')

    // Uncommenting setScanned(false) causes the crash.
    // setScanned(false)
  }
